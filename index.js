...
function customAssign(...objects) {
  let assignN = Object.assign(...objects);
  return assignN;
  // let assignNN = {};
  // for (let key in assignN) {
  //   if
  //   return assignN[key];
  // }

  // // let assignNN = assignN.toString();
  // // return assignNN;
...
function customEntries(obj) {
  let customEntries = Object.entries(obj);
...
function customObjectFromEntries(entries) {
  ...
  const NN = entries.map(([key, value]) => {
    return `${key} : ${value}`;
  });
  // return NN;
  const N = Object.fromEntries(entries);
  return N;
}
...
function keysAndValues(obj) {
  let keyN = Object.keys(obj);
  let valueN = Object.values(obj);

  let result = [keyN, valueN];
...
function filterObjectsByKey(arr, key) {
  ...
  let filterN = arr.filter((elemet) => (elemet = key));
  return filterN;
